...
type M20260327000009CreateAccountUsersTable struct{}

func (r *M20260327000009CreateAccountUsersTable) Signature() string {
	return "20260327000009_create_account_users_table"
}

func (r *M20260327000009CreateAccountUsersTable) Up() error {
...
func (r *M20260327000009CreateAccountUsersTable) Down() error {
